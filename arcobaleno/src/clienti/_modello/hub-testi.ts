 ...
 *
 * STATO e' la sezione "cosa c'e' online adesso". Per un cliente che un sito
 * ce l'ha, e' l'audit di quel sito. Per uno che non ce l'ha, e' cosa si trova
 * cercandolo: l'assenza e' l'argomento piu' forte che ci sia, non un buco da
 * saltare. Se davvero non c'e' niente da dire, si mette a null e la sezione
 * non viene resa.
 *
 * Regola di tono, non negoziabile: nessun rimprovero. Il sito attuale puo'
 * averlo fatto qualcuno di famiglia, e non averne uno non e' un errore. Il
 * soggetto delle frasi e' il software o quello che succede in rete, mai il
 * cliente.
 *
 * Ogni cifra grande deve essere contata, mai stimata. Dove non c'e' un numero
 * vero si mette `dato: null` e resta solo il testo.
 *
